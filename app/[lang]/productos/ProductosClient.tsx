...
export default function ProductosClient({ products, productLines, categories }: ProductosClientProps) {
  ...
  return (
    <div className="pt-20">
                ...
                return (
                  ...
                  >
                    ...
                    {lineProducts.length > 0 && (
                      <ProductLineRow line={line} products={lineProducts} firstLine={segIndex === 0} dict={dict} lang={lang} />
                    )}
                  </m.div>
                );
              })}
      ...
      {/* WhatsApp CTA — inline conversion banner */}
      {(() => {
        // TODO: add to dict — keys: products.whatsappCta.text / products.whatsappCta.button
        ...
        const { appUrl, webUrl } = buildWhatsAppLinks(
          ...
          lang === "es" ? "Hola, me interesa un producto del catálogo" : "Hello, I'm interested in a product from your catalog",
        );
        const href = appUrl ?? webUrl ?? "#";
        return (
          <div className="bg-primary/8 border-y border-primary/15 py-5">
            <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
              <p className="text-text-main font-medium text-sm text-center sm:text-left">
                {waText}
              </p>
              <a
                href={href}
                ...
                className="shrink-0 inline-flex items-center gap-2 bg-primary hover:bg-primary-dark text-white font-semibold text-sm py-2.5 px-6 rounded-full transition-all hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-surface-page whitespace-nowrap"
              >
