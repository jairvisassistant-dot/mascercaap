    ...
    <>
      ...
      <section className="py-20 bg-gray-900 border-t border-white/5">
        <div className="max-w-3xl mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-primary/15 border border-primary/25 text-primary text-xs font-bold tracking-[0.2em] uppercase px-4 py-2 rounded-full mb-8">
          ...
          <Link
            ...
            className="inline-flex items-center gap-3 bg-accent hover:bg-accent-dark text-white font-bold py-4 px-10 rounded-full transition-all hover:scale-105 text-base shadow-lg shadow-accent/30"
          >
