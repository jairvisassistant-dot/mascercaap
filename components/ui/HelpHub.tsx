...
export default function HelpHub() {
  const { isOpen, openDrawer, closeDrawer } = useHelpHub();
  ...
  return (
    <>
      ...
      >
        ...
        <span className="hidden sm:inline text-sm font-semibold whitespace-nowrap">{t.trigger}</span>
      </m.button>

      <AnimatePresence>
        {isOpen && <HelpDrawer onClose={closeDrawer} />}
      </AnimatePresence>
    </>
  );
}
