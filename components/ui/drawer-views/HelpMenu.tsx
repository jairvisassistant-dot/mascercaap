...
export default function HelpMenu({ onNavigate }: Props) {
  ...
  return (
    <div className="flex flex-col h-full">
      <p className="text-sm text-gray-500 px-6 pt-4 pb-2">{t.menuSubtitle}</p>
      ...
      <nav className="flex-1 overflow-y-auto">
        {MENU_ITEMS.map(({ view, icon }) => (
          <button
            ...
            className="w-full flex items-center gap-4 px-6 py-4 border-b border-gray-100 hover:bg-gray-50 transition-colors text-left group"
          >
            <span className="text-primary shrink-0">{icon}</span>
            <span className="flex-1 text-sm font-medium text-gray-800">
              {t.menu[view as keyof typeof t.menu]}
            </span>
            <svg
        ...
        <a
          ...
          className="w-full flex items-center gap-4 px-6 py-4 border-b border-gray-100 hover:bg-green-50 transition-colors group"
        >
