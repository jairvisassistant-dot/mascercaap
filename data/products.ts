...
export const productLines: ProductLineConfig[] = [
  ...
  {
    key: "pulpa-feijoa",
    label: "Pulpa de Feijoa",
    description: "Sabor único colombiano que no encontrás en ningún otro lugar.",
    gradient: "from-lime-400 to-green-500",
    iconEmoji: "🍏",
  },
  {
...
export const products: Product[] = [
  ...
  // Feijoa — 3 presentaciones
  {
    ...
    image: "/imgs/fruta-feijoa.webp",
    description: "Porción individual lista para preparar. Feijoa colombiana, sabor único que no encontrás en otro lugar.",
  ...
  },
  {
    ...
    image: "/imgs/fruta-feijoa.webp",
    description: "Ideal para jugos y postres artesanales. Feijoa colombiana congelada en su punto exacto.",
    ingredients: ["Feijoa 100% natural"],
    benefits: ["Vitamina C", "Fibra natural", "Sin conservantes"],
  },
  {
    id: "pulpa-feijoa-1000",
    name: "Pulpa de Feijoa",
    line: "pulpa-feijoa",
    presentation: "1000g",
    presentationOrder: 18,
    image: "/imgs/fruta-feijoa.webp",
    description: "Presentación institucional para negocios y restaurantes. Feijoa colombiana 100% natural.",
    ingredients: ["Feijoa 100% natural"],
    benefits: ["Vitamina C", "Fibra natural", "Sin conservantes"],
  },
